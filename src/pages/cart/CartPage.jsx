                                    ...
                                    <div className="flex gap-4 mb-6">
                                        {user
                                            ...
                                            <BuyNowModal
                                                ...
                                                openPaymentModal={openPaymentModal} // Pass the function to open PaymentModal
                                            />
                                            <PaymentModal
                                                buyNowFunction={buyNowFunction}
                                                isOpen={paymentModalOpen}
                                                setIsOpen={setPaymentModalOpen}
                                                price={cartTotal} // Pass the total price to PaymentModal
                                            />
