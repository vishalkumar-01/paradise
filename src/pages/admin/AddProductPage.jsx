                ...
                <div className="login_Form bg-gray-50 px-8 py-6 border border-gray-100 rounded-xl shadow-md">
                    ...
                    <div className="mb-3">
                        <textarea
                            ...
                            }} name="description" placeholder="Product Description" rows="5" className=" w-full px-2 py-1 text-gray-800 bg-gray-50 border border-gray-200 rounded-md outline-none placeholder-gray-800 ">
