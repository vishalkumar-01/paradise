                                                        ...
                                                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                            ...
                                                            <div className="mb-4">
                                                                ...
                                                                {status === 'pending' ?
                                                                    ...
                                                                    : <div className="text-sm font-medium text-gray-800 first-letter:uppercase">{status}</div>
                                                                }
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div className="flex flex-1 items-stretch">
                                                                    ...
                                                                    <div className="ml-5 flex flex-col justify-between">
                                                                        <div className="flex-1">
                                                                            ...
                                                                            <p className="mt-1.5 text-sm font-medium text-gray-900">{category}</p>
                                                                        </div>

                                                                        <p className="mt-4 text-sm font-medium text-gray-900">x {quantity}</p>
                                                                    </div>
                                                                </div>
